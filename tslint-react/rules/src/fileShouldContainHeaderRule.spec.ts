...
import { Rule } from './fileShouldContainHeaderRule';

const rule = 'file-should-contain-header';

describe('fileShouldContainHeaderRule test examples [actually a sample rule that disallows debugger statements]', () => {
